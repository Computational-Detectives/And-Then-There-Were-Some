...
from .config import (
    RAW_TEXT, CLEAN_NAMES, OUT_DIR, CHAR_RES_OUT, SPACY_MODEL,
...
def build_alias_dict(
    ...
    for form, sids in unique_forms.items():
        cid, fullname, score, corrected_gender = match_name(
            form, "u",
            variant_to_ids, all_variants, id_to_gender,
            clean_names, all_name_tokens,
...
def main(
    ...
    """Run NER + fuzzy match → alias dictionary."""
