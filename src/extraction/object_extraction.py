...
from ..config import (
    RAW_TEXT, CLEAN_NAMES, TOKENS, 
    COREF_OUT, VERB_OUT, OBJ_OUT, PRONOUNS
    )
...
def main(
    ...
    # ------------------ PRINT STATISTICS -------------------
    if verbose:
        print_verbose_stats(protagonist_df=protagonist_df, non_protagonist_df=non_protagonist_df, 
                            include_non_protagonist=include_non_protagonist)
